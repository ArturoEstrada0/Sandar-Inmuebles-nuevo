...
import {
  ...
  NumberOutlined,
  BathOutlined,
} from '@ant-design/icons'; import { useParams } from 'react-router-dom';
...
const PropertyDetail = () => {
  ...
  return (
    <Content>
      <div style={{ display: 'flex', justifyContent: 'space-between', paddingLeft: '30px', alignItems: 'center' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: '1', maxWidth: '30%', maxHeight: '60vh' }}>
              <Card style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Title level={4} className="contact-title" style={{ textAlign: 'center' }}>
                  SANDAR INMUEBLES
                </Title>
                <Title level={4} className="contact-title" style={{ textAlign: 'center' }}>
